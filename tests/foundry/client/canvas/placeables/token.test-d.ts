...
expectTypeOf(
  token.constrainMovementPath(constrainWaypoints, constrainOptions),
...
expectTypeOf(token.findMovementPath(findWaypoints, findOptions)).toEqualTypeOf<Token.FindMovementPathJob>();
