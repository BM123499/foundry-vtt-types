...
expectTypeOf<Extract<CONST.PRIMARY_DOCUMENT_TYPES, "ActiveEffect">>().toEqualTypeOf<"ActiveEffect">();
...
expectTypeOf<"ASCEND">().toExtend<keyof typeof CONST.MOVEMENT_DIRECTIONS>();
expectTypeOf<"DESCEND">().toExtend<keyof typeof CONST.MOVEMENT_DIRECTIONS>();
